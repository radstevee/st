 ...
 */
static char *font = "Geist Mono :pixelsize=15:antialias=true:autohint=true";
static char *font2[] = {
    "GeistMono Nerd Font :pixelsize=12:antialias=true:autohint=true"};
...
static const char *colorname[] = {
    /* 8 normal colors */
    "#1c1e27", "#dd6777", "#90ceaa", "#ecd3a0", "#86aaec", "#c296eb", "#93cee9",
    "#cbced3",

    /* 8 bright colors */
    "#151720", "#e26c7c", "#95d3af", "#f1d8a5", "#8baff1", "#c79bf0", "#98d3ee",
    "#d0d3d8",

    [256] = "#a5b6cf", /* default foreground colour */
    [257] = "#0d0f18", /* default background colour */
    [258] = "#C3BAC6", /*575268*/
